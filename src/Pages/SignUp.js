            ...
            <section class="text-gray-600 body-font relative background-Color py-6">
                <div class="container px-5 py-24 mx-auto">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div class="lg:w-2/5 md:w-2/3 mx-auto  shadow-lg p-8 background-color">
                            ...
                            <div class="flex flex-wrap -m-2 ">
                                ...
                                <div class="p-2 w-full text-left">
                                    <div class="relative">
                                        ...
                                        type="text" name="name" className="w-full secondary-color  rounded border border-black text-black  focus:ring-2 focus:ring-indigo-200 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                ...
                                <div class="p-2 w-full text-left">
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            type="email" name="email" class="w-full secondary-color border-white   rounded border   focus:border-indigo-500  focus:ring-2 focus:ring-indigo-200 text-black  outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                        <label for="email" className="leading-7 text-sm text-gray-600 text-left">
                                ...
                                <div class="p-2 w-full text-left">
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            type="text" name="password" class="w-full secondary-color border-black    rounded border border-gray-300 focus:border-indigo-500  focus:ring-2 focus:ring-indigo-200 text-base outline-none text-black  py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                        <label for="email" className="leading-7 text-sm text-gray-600 text-left">
                                ...
                                <div class="p-2 w-full text-left">
                                    <div class="relative">
                                        ...
                                        type="text" name="age" class="w-full secondary-color  border-black  rounded border  focus:border-indigo-500  focus:ring-2 focus:ring-indigo-200  outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                ...
                                {signInError}
                                    <button className='btn button-bg lg:w-full md:w-full sm:w-full mt-4'>Sign Up Now</button>
                                </div>
                                {/* </form> */}
                            </div>
                            <div className=''>
                                <p className='pt-5 mb-3 text-white'>Already Member?? <span className='logo cursor-pointer' onClick={() => navigate('/login')} >Log in</span></p>
